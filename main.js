...
app.controller('legis', function($scope, $http) {
    
    $http.get("http://congress.api.sunlightfoundation.com/legislators?apikey=b8ba30d18f3b48259227944edff23ca3&per_page=all")
    .then(function(response) {
    $scope.selectedData = response.data;
    $scope.Name = 'Legislator';
...
//function getLegislatorDetails(){
    //alert("Get Lagislator details");
    $.ajax({
        url: 'index.php?call=getLegislatorDefaultDetails',   // replace by AWS's PHP URL
        data: {call:'getLegislatorDefaultDetails'},
        type: 'GET',
        dataType : 'json',
        success: function(response, status, xhr){
            
            //var phpReturn = JSON.parse(response);
            //$scope.parsedJson = response["results"];
            
            //alert(response);
               //console.log(response);

                //$scope.selectedData = JSON.parse(response);
        ...
        error: function(xhr, status, error){
            alert("PHP CALL for legislator default details failed");
        }
    });
...
function getBillDetails(){
    ...
    $.ajax({
        ...
        type: 'GET', 
        data: {call:'getBillDefaultDetails'},
...
function getCommitteesDetails(){
    ...
    $.ajax({
        url: 'hw8.php',   // replace by AWS's PHP URL
        data: {call:'getCommitteesDefaultDetails'},
        type: 'GET',
        success: function(response, status, xhr){
...
function getFavoritesDetails(){
    ...
    $.ajax({
        url: 'hw8.php',   // replace by AWS's PHP URL
        data: {call:'getFavoritesDefaultDetails'},
        type: 'GET',
        success: function(response, status, xhr){
